...
In this assignment, we accurately predicted the classification of 20 observations using a Random Forest algoritshm trained on a subset of data using less than 20% of the covariates.
